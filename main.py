...
from market_data import get_current_prices, get_weekly_changes, get_usd_to_cad_rate, get_market_indices_change, get_fundamental_data, get_technical_data, get_latest_news
