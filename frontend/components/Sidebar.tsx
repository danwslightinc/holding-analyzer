...
import { Home, TrendingUp, PieChart, DollarSign, Sun, Moon, Brain, List, RefreshCw, BarChart2, LogOut, Activity } from "lucide-react";
...
const NAV_ITEMS = [
    ...
    { name: "Trade Analysis", icon: Activity, href: "/trade-analysis" },
